    ...
    const fetchAllClasses = async () => {
      try {
        ...
        const response = await axios.get(
          `${backendUrl}/api/teachers/get-class-with-stds/`,
  ...
  const handleClassSelect = async (classData) => {
    ...
    try {
      ...
      const teacherResponse = await axios.get(
        `${backendUrl}/api/teachers/class-teacher/${classData.id}/`,
        { withCredentials: true }
      );
  ...
  const markClassStatus = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        `${backendUrl}/api/teachers/mark-class-status/${selectedClass.id}/`,
        {},
        { withCredentials: true }
      );
