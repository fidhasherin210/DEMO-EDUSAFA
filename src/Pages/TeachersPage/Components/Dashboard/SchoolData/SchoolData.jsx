...
// Sample data for when totals prop is not provided
const SAMPLE_TOTALS = {
  total_students:100,
  total_teachers: 5,
  total_notices: 24,
...
function SchoolData({ totals }) {
  // Use sample data if totals prop is not provided
  const data = totals || SAMPLE_TOTALS
            ...
            <div className="flex-1">
              ...
              {isLoading.students ? (
                ...
                <p className="text-sm md:text-2xl lg:text-3xl font-bold text-gray-800">
                  {formatCount(data?.total_students)}
                </p>
              )}
          ...
          <div className="flex flex-col items-center text-center md:flex-row md:text-left md:items-start gap-2 md:gap-4">
            ...
            <div className="flex-1">
              ...
              {isLoading.teachers ? (
                ...
                <p className="text-sm md:text-2xl lg:text-3xl font-bold text-gray-800">
                  {formatCount(data?.total_teachers)}
                </p>
              )}
              <p className="text-[8px] md:text-xs text-gray-400 mt-0.5 md:mt-1">
                Staff members
          ...
          <div className="flex flex-col items-center text-center md:flex-row md:text-left md:items-start gap-2 md:gap-4">
            ...
            <div className="flex-1">
              ...
              {isLoading.notice ? (
                ...
                <p className="text-sm md:text-2xl lg:text-3xl font-bold text-gray-800">
                  {formatCount(data?.total_notices)}
                </p>
              )}
              <p className="text-[8px] md:text-xs text-gray-400 mt-0.5 md:mt-1">
                Upcoming events
