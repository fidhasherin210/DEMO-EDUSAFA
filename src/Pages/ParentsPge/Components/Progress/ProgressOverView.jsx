...
const ProgressOverView = ({ progressData: propProgressData, stats: propStats }) => {
  ...
  const progressData = propProgressData || sampleProgressData
  const stats = propStats || sampleStats
  ...
  const totalFullMarks = progressData.reduce(
          ...
          <div className="grid grid-cols-4 gap-1 mb-3">
            ...
            <div className="flex flex-col items-center bg-gradient-to-br from-purple-50 to-pink-50/50 rounded-2xl py-3 px-1 border border-purple-100/50">
              <span className="text-lg font-bold text-purple-600">
                {stats?.total_subjects || progressData.length}
              </span>
            ...
            <div className="flex pt-4 flex-col items-center bg-gradient-to-br from-amber-50 to-orange-50/50 rounded-2xl py-3 px-1 border border-amber-100/50">
              <span className="text-base font-bold text-amber-600">
                {stats?.average_marks ||
                  (totalMarks / progressData.length).toFixed(1)}
              </span>
