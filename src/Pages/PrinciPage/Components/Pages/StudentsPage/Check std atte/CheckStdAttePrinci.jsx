...
const CheckStdAttePrinci = () => {
  ...
  const handleImageError = (e) => {
    ...
    e.target.src = 'https://images.unsplash.com/photo-1633332755192-727a05c4013d?w=150&h=150&fit=crop'
  }
  ...
  const handleStudentSelect = (student) => {
    ...
    setLoading(true)
    setTimeout(() => {
      setAttendanceRecords(generateSampleAttendance(student.id))
      setLoading(false)
    }, 500)
  }
  ...
  const handleAcademicYearChange = (e) => {
    ...
    if (selectedStudent) {
      setLoading(true)
      setTimeout(() => {
        setAttendanceRecords(generateSampleAttendance(selectedStudent.id))
        setLoading(false)
      }, 500)
    }
  }
