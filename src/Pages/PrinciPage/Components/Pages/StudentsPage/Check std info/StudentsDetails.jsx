    ...
    students: [
      {
        ...
        parent_name: "Rajesh Krishnan",
        parent_occupation: "Software Engineer",
        blood_group: "O+",
        phone_no: "+91 9876543210",
        dob: "2015-05-15",
        former_school: "Little Flower School",
        address: "Villa No. 45, Green Valley, Thiruvananthapuram - 695001",
      ...
      },
      {
        ...
        total_fee_amount: 25000,
        admission_date: "2024-06-01",
        parent_name: "Abdul Rahiman",
        parent_occupation: "Business Owner",
        blood_group: "B+",
        phone_no: "+91 9876543211",
        dob: "2015-08-22",
        former_school: "Al-Ameen Public School",
        address: "House No. 23, Marine Drive, Kochi - 682011",
      ...
      },
      {
        ...
        dob: "2015-03-10",
        former_school: "St. Joseph's School",
        address: "Manorama House, Beach Road, Kozhikode - 673001",
        updated_at: "2025-02-16T09:15:00"
      }
    ]
  },
  {
    ...
    students: [
      {
        ...
        address: "Plot 12, Ashramam Road, Kollam - 691001",
        updated_at: "2025-02-13T11:20:00"
      },
      {
        id: 202,
        name: "Aysha Bathool",
        ...
        total_fee_amount: 26000,
        admission_date: "2024-06-01",
        parent_name: "Thomas Mathew",
        parent_occupation: "Doctor",
        blood_group: "O-",
        phone_no: "+91 9876543214",
        dob: "2014-11-25",
        former_school: "Holy Family School",
        address: "House 78, Chembukkavu, Thrissur - 680020",
    ...
    students: [
      {
        ...
        dob: "2013-09-05",
        former_school: "St. John's School",
        address: "Nair House, College Road, Pathanamthitta - 689645",
        updated_at: "2025-02-16T16:45:00"
      }
    ]
  }
];
...
const StudentsDetails = () => {
  ...
  const fetchStudentDetails = async (studentId) => {
    ...
    // Simulate API delay
    setTimeout(() => {
      // Find the student details from sample data
  ...
  const getImageUrl = (url) => {
    if (!url) return null
    return url // Return as-is since we're using UI Avatars URLs
  }
