...
function MarkStdProgressPrinci() {
  ...
  // Sample terms data
  const sampleTerms = [
    { id: 1, name: "Term 1", period: "2024" },
    { id: 2, name: "Term 2", period: "2024" },
    { id: 3, name: "Term 3", period: "2024" },
    { id: 4, name: "Term 1", period: "2025" },
    { id: 5, name: "Term 2", period: "2025" },
  ]

  // Sample subjects data for different classes
  const sampleSubjectsByClass = {
   1: [
  { id: 101, name: "Fiqh" },
  { id: 102, name: "Akhlaq" },
  { id: 103, name: "Tareekh" },
...
5: [
  ...
  const fetchSubjects = async (classId) => {
    ...
    setTimeout(() => {
      try {
        const classSubjects = sampleSubjectsByClass[classId] || sampleSubjectsByClass[1]
  ...
  const handleSubmit = async () => {
    ...
    // Validate marks are numbers between 0-100
                ...
                <div key={student.id} className="space-y-3">
                  ...
                  {selectedStudent?.id === student.id && showMarksForm && (
                    <div className="animate-in slide-in-from-top duration-300">
                      ...
                      {error && (
                        <div className="mt-2 text-xs md:text-sm bg-red-50 p-4 rounded-xl animate-in slide-in-from-left duration-300">
                          <div className="flex items-center">
                      ...
                      {success && (
                        <div className="mt-2 text-xs md:text-sm bg-green-50 p-4 rounded-xl animate-in slide-in-from-left duration-300">
                          <div className="flex items-center">
