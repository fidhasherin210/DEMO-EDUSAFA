        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-200">
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid md:grid-cols-2 gap-4">
              <div>
                <label className="block text-xs md:text-sm font-semibold text-blue-600 mb-1">Parent Name</label>
                <input
                  name="name"
                  value={parent.name}
              ...
              <div>
                <label className="block text-xs md:text-sm font-semibold text-blue-600 mb-1">Place</label>
                <input
                  name="place"
                  value={parent.place}
                  onChange={handleParentChange}
              ...
              <div>
                <label className="block text-xs md:text-sm font-semibold text-blue-600 mb-1">Age</label>
                <input
                  name="age"
                  value={parent.age}
                  onChange={handleParentChange}
              ...
              <div>
                <label className="block text-xs md:text-sm font-semibold text-blue-600 mb-1">Job</label>
                <input
                  name="job"
                  value={parent.job}
                  onChange={handleParentChange}
              ...
              <div className="md:col-span-2">
                <label className="block text-xs md:text-sm font-semibold text-blue-600 mb-1">Contact Number</label>
                <input
                  name="number"
                  value={parent.number}
                  onChange={handleParentChange}
            ...
            <div>
              <h3 className="text-sm md:text-lg font-semibold text-blue-600 mt-4 mb-2">
                Family Members
              </h3>
              ...
              {members.map((member, index) => (
                ...
                >
                  ...
                  <div>
                    <label className="block text-xs md:text-sm font-semibold text-gray-600 mb-1">Job</label>
                    <input
                      name="job"
                      value={member.job}
                      onChange={(e) => handleMemberChange(index, e)}
                  ...
                  <div>
                    <label className="block text-xs md:text-sm font-semibold text-gray-600 mb-1">Age</label>
                    <input
                      name="age"
                      value={member.age}
                      onChange={(e) => handleMemberChange(index, e)}
                  ...
                  <div>
                    <label className="block text-xs md:text-sm font-semibold text-gray-600 mb-1">Marital Status</label>
                    <input
                      name="martial_status"
                  ...
                  <div>
                    <label className="block text-xs md:text-sm font-semibold text-gray-600 mb-1">Relation</label>
                    <input
                      name="relation"
              ...
              <button
                ...
                className="inline-flex items-center bg-green-800 text-white px-4 py-2 rounded-lg transition hover:from-blue-600 hover:to-purple-700 focus:ring-2 focus:ring-blue-300 focus:outline-none"
              >
                + Add Another Member
              </button>
            </div>
