...
function ParentsDetailsPrinci() {
  ...
  useEffect(() => {
    axios
      .get(`${backendUrl}/api/principal/parents/`, { withCredentials: true })
      .then((response) => {
  ...
  const handleRowClick = (parentId) => {
    ...
    if (!members[parentId]) {
      axios
        .get(`${backendUrl}/api/principal/get-members/${parentId}`, {
          ...
          <div className="mx-auto ">
            ...
            <div className="mt-4 w-full">
              ...
              <input
                ...
                className="border border-gray-100 rounded px-4 py-2 w-full md:w-full h-[42px]"
                value={searchQuery}
...
export default ParentsDetailsPrinci
