...
const ThrAttendanceAuth = () => {
    ...
    const fetchAttendanceSummary = async () => {
      ...
      try {
        const response = await fetch(
          `${backendUrl}/api/authority/all-teachers-attendance-summery/`,
          {
            method: "GET",
            credentials: "include",
          }
  ...
  useEffect(() => {
    if (selectedTeacher) {
      setLoading(true);
      let url = `${backendUrl}/api/authority/all-tchr-attendance/${selectedTeacher}/?year=${selectedYear}&timestamp=${new Date().getTime()}`;
  ...
  useEffect(() => {
    if (selectedTeacher) {
      ...
      const url = `${backendUrl}/api/authority/all-tchr-attendance/${selectedTeacher}/?year=${selectedYear}`;
      fetch(url, {
        method: "GET",
        credentials: "include",
      })
