...
import { Upload, FileImage, Trash2, Camera, Book } from 'lucide-react'
...
const AddGallery = () => {
  ...
  const [gallery, setGallery] = useState([
    ...
    },
    {
      ...
      title: 'Science Exhibition - Innovative projects by our young scientists'
    },
    {
      id: 3,
      image: 'https://images.unsplash.com/photo-1509062522246-3755977927d7?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80',
      title: 'Cultural Fest 2024 - Students showcasing traditional dance performances'
    },
    {
      id: 4,
      image: 'https://images.unsplash.com/photo-1577896851231-70ef18881754?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80',
      title: 'Computer Lab Session - Students learning programming skills'
    },
    {
      id: 5,
      image: 'https://images.unsplash.com/photo-1503676260728-1c00da094a0b?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80',
      title: 'Library Hours - Encouraging reading habits among students'
    },
    {
      id: 6,
      image: 'https://images.unsplash.com/photo-1541339901998-5f2a8701c1c6?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80',
      title: 'Graduation Day - Celebrating the achievements of Class of 2024'
    },
    {
      id: 7,
      image: 'https://images.unsplash.com/photo-1580582932707-520aed937b7b?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80',
      title: 'Art Competition - Students expressing creativity through colors'
    },
    {
      id: 8,
      image: 'https://images.unsplash.com/photo-1524178232363-1fb2b075b655?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80',
      title: 'Field Trip to Science Museum - Educational visit for grade 6 students'
    }
  ])
  ...
  const handleSubmit = async (e) => {
    ...
    setTimeout(() => {
      // Create a new gallery item with sample image URL
      const newItem = {
        id: gallery.length + 1,
              ...
              {gallery.length > 0 ? (
                ...
                <div className="text-center py-16">
                  ...
                  <p className="text-gray-500">
                    Start building your school&apos;s gallery by uploading the
                    first image!
                  </p>
                </div>
              )}
